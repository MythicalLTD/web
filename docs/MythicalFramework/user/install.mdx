...
| ---------------------- | ------- | --------- | -------------------------------------------------------- |
| [Ubuntu](os/ubuntu) | >=20.04 | ✅        | This will require you to use additional repo's           |
| [Debian](os/deb)    | >=10    | ✅        | This will require you to use additional repo's           |
...
If you are using a WebHosting panel your only way to install the framework is via the GUI interface.

Welcome to our installation documents for MythicalFramework
...
Now you have to create a new SSL certificate and for that we have a nice tutorial that you can find here
- [Creating a ssl certificate](/docs/MythicalFramework/user/ssl-cert)
...
- [Apache2](/docs/MythicalFramework/user/webservers/apache)
- [Nginx](/docs/MythicalFramework/user/webservers/nginx)