...
- [MythicalDash](/docs/MythicalDash/intro): A powerful pterodactyl dashboard meant to start free hosting's and even paid with our payment integration.
- [MythicalFramework](/docs/MythicalFramework): A powerful web development framework that simplifies the process of building modern and responsive websites.